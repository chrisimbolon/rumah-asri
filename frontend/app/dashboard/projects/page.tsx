...
//  Sprint 17 : Live Event Stream + Readiness Momentum - moved OUT
//    to app/dashboard/page.tsx as part of Sprint 19 (Command Center).
//    This page goes back to being the projects list/filter/create
//    page — Event Stream + Portfolio Intelligence Hub now live on
//    the main dashboard instead, per the roadmap's explicit call
//    for Event Stream to be the first thing you see there.
// ================================================
